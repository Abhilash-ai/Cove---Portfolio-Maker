// Source: react-bits.dev — DecryptedText
// Adapted for Cove Design Engine to dynamically read colors from colorTokens
    ...
    <motion.span
      ...
      onViewportEnter={() => {
        if (animateOn === 'view' && !hasAnimated) {
          setHasAnimated(true);
          setIsHovering(true);
          setTimeout(() => setIsHovering(false), (text.length + maxIterations) * speed);
        }
      }}
      viewport={{ once: true }}
    >
